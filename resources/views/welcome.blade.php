...
<head>
	...
	<link rel="preload stylesheet" href="{{asset('user/css/style.css')}}" as="style">
</head>
					...
					<div class="blog-items">
						<div class="blog-item">
							<a href="#" class="blog-item__img">
								<img data-src="https://via.placeholder.com/555x300" src="data:image/gif;base64,R0lGODlhAQABAAAAACw="
									class="js-img" alt="">
					...
					<ul class="header-nav">
						...
						<li><a href="#">pages</a>
							<ul>
                                ...
                                <li><a href="checkout1.html">Checkout1</a></li>
                                <li><a href="checkout2.html">Checkout2</a></li>
								<li><a href="checkout3.html">Checkout3</a></li>
