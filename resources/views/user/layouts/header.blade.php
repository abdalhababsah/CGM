<header class="header">
    ...
    <div class="header-content">
        <div class="header-logo">
            <img src="{{ asset('path/to/logo.png') }}" alt="@lang('home.header_logo_alt')">
        </div>
        <div class="header-box">
            <ul class="header-nav">
                <li><a href="{{ route('home') }}" class="{{ Request::is('/') ? 'active' : '' }}">{{__('home.nav_home')}}</a></li>
                <li><a href="{{ route('shop.index') }}">{{__('home.nav_shop')}}</a></li>
                <li><a href="{{ route('cart.index') }}">{{__('home.nav_cart')}}</a></li>
                <li><a href="{{ route('wishlist.index') }}">{{__('home.nav_wishlist')}}</a></li>
