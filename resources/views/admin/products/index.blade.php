                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" id="search" name="search" class="form-control"
                                        placeholder="Search by Name (EN, AR, HE)" value="{{ request('search') }}">
                                </div>
                                ...
                                <tbody>
                                    @forelse ($products as $product)
                                        <tr>
                                            ...
                                            <td class="align-middle text-left">
                                                {{ $product->category->name_en ?? 'No Category' }}</td>
                                            <td class="align-middle text-left">{{ $product->brand->name_en ?? 'No Brand' }}
                                            </td>
                                            <td class="align-middle text-right">₪{{ number_format($product->price, 2) }}
                                            </td>
                                            ...
                                            <td class="align-middle text-left">
                                                En:
                                                {{ \Illuminate\Support\Str::words($product->description_en, 3, '...') }}<br>
                                                Ar:
                                                {{ \Illuminate\Support\Str::words($product->description_ar, 3, '...') }}<br>
                                                He:
                                                {{ \Illuminate\Support\Str::words($product->description_he, 3, '...') }}
                                            </td>
                                            <td class="align-middle text-center">
                                                <span
                                                    class="badge {{ $product->is_active ? 'bg-gradient-success' : 'bg-gradient-secondary' }}">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="10" class="text-center text-secondary text-sm">No products found.
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
                    ...
                    <div class="table-responsive mb-4">
                        <table class="table table-hover border">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <span class="fw-bold text-primary">description_en, description_ar,
                                            description_he</span>
                                        <small class="d-block text-muted">Product descriptions in different
                                            languages</small>
                                    </td>
