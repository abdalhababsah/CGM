    ...
    <div class="invoice-container">
        <div class="invoice-header">
            ...
            <div class="invoice-details">
                ...
                <p><strong>تاريخ الاستحقاق:</strong> {{ $order->created_at->addDays(30)->format('d M Y') }}</p>
            </div>
        </div>
        ...
        <div class="invoice-footer">
            <p><strong>المجموع الفرعي:</strong> ₪ {{ number_format($order->total_amount, 2) }}</p>
            <p class="total-amount"><strong>المجموع الكلي:</strong> ₪ {{ number_format($order->total_amount, 2) }}</p>
        </div>
    </div>
</body>
